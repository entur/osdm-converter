...
tasks.register<GenerateTask>("generateOffersSpec") {
	validateSpec.set(false)
	inputSpec.set("$rootDir/src/main/resources/offers.json")
	generatorName.set("kotlin-spring")
	outputDir.set("${buildDir}/generated-openapi/offers")
	modelPackage.set("org.entur.offers")
	...
	sourceSets["main"].java.srcDir(file("${buildDir}/generated-openapi/offers/src/main"))
}

tasks.register<GenerateTask>("generateOsdmSpec") {
	validateSpec.set(false)
	inputSpec.set("$rootDir/src/main/resources/OSDM-online-api-v3.0.2.yml")
	generatorName.set("kotlin-spring")
...
tasks.compileKotlin {
	dependsOn(tasks.getByName("generateOffersSpec"))
